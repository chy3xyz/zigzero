...
pub extern "c" fn PQexecParams(conn: ?*PGconn, command: [*c]const u8, nParams: c_int, paramTypes: ?[*]const Oid, paramValues: ?[*]const ?[*]const u8, paramLengths: ?[*]const c_int, paramFormats: ?[*]const c_int, resultFormat: c_int) ?*PGresult;
